...
export { fallback };
export declare const protobufFromJSON: typeof fallback.GrpcClient.protobufFromJSON;
...
export { makeUUID, decodeAnyProtosInArray, decodeProtobufAny, checkTelemetryEnabled, } from './util';
